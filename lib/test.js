...
describe('#module', function () {
    ...
    it('#trainStatus should return expected data on request', function () {
        ...
        return _module.trainStatus(data).then(function (v) {
            expect(v.ritardo).to.be.equal(23);
            expect(v.binarioArrivo).to.be.equal(8);
        });
    });
    it('#trainStatus should get decrease in time', function () {
        var data = {
            partenza: 'S01301',
            arrivo: 'S01700',
            treno: '25527',
    ...
    it('#trainStatus should update ultimo rilevamento', function () {
        var data = {
            partenza: 'S01301',
            arrivo: 'S01700',
            treno: '25527',
